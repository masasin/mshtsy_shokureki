...
\begin{document}
\thispagestyle{plain}
\makeheading[\emph{職務経歴書}]{勝者神優{\scriptsize{マサヒト・シンユウ}}}

\section{\footnotesize{2015年2月15日現在}}
...
\item[] 幼い頃からロボットに興味を持ったから、大学で学びましたが、前職や個人で得たスキルと知識を貴社で活かしたいです．
  私は人類の自動化を実現したい者です．
  産業ロボットで行う貴社の動作計画のアルゴリズムを一般ロボットに利用したら「すべての人のために個人用ロボット」となれるでしょう．
\end{outerlist}
\flushright{以上．}
